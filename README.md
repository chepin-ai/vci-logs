<!-- CLASSIFY: L0 -->
# vci-logs —— ci-logs 之公域 CI 影子引擎（SHADOW-CI-01 矩阵 · 归档考古）

**意图**：公域影子：归档并维护链/哈希，爬取外部会话与 Cron/Daemon 公开记录，深度考古与历史复现
...
- 引擎升级经 provision 车道（ci-control/provision/vci/vci-logs/）幂等下发。
